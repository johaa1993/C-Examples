...
#define Timer_Counter_Count_Max 65535
...
#define Timer_Counter_Channel_Mode_Register_Clock_Selection_Timer_Clock_1_Mask \
(Timer_Counter_Channel_Mode_Register_Clock_Selection_Timer_Clock_1 << Timer_Counter_Channel_Mode_Register_Clock_Selection_Offset)

#define Timer_Counter_Channel_Mode_Register_Clock_Selection_Timer_Clock_2_Mask \
(Timer_Counter_Channel_Mode_Register_Clock_Selection_Timer_Clock_2 << Timer_Counter_Channel_Mode_Register_Clock_Selection_Offset)
